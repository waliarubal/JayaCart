...
export class UserAccountService extends BaseService {
    ...
    RegisterMethods(): void {
        this.Application.post(`/${this.USER_ACCOUNTS}`, async (request, response) => {
            try {
        ...
        this.Application.patch(`/${this.USER_ACCOUNTS}/:PhoneNumber`, async (request, response) => {
            try {
        ...
        this.Application.get(`/${this.USER_ACCOUNTS}/:PhoneNumber`, (request, response) => {
        ...
        this.Application.get(`/${this.USER_ACCOUNTS}`, (request, response) => {
        ...
        this.Application.delete(`/${this.USER_ACCOUNTS}/:PhoneNumber`, async (request, response) => {
